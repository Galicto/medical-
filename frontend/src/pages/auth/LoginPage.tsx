            ...
            >
                <Card style={{
                    ...
                    <CardHeader className="space-y-3 pb-2">
                        ...
                        <CardTitle className="text-2xl font-bold text-center text-white">MedLife HMS</CardTitle>
                    ...
                    <CardContent className="pt-2">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <Button type="submit" className="w-full h-11 text-sm font-semibold text-white" disabled={isLoading}
                    ...
                    <CardFooter className="justify-center pb-6">
                        <p className="text-sm" style={{ color: '#64748B' }}>
                            Forgot password?{' '}<a href="#" className="hover:underline" style={{ color: '#818CF8' }}>Reset here</a>
                        </p>
                    </CardFooter>
                </Card>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="flex items-center">
                                            <span className="text-xs font-mono" style={{ color: '#CBD5E1' }}>{cred.email}</span>
                                            <CopyButton text={cred.email} />
                                        </div>
                                        <div className="flex items-center">
                                            <span className="text-xs font-mono" style={{ color: '#64748B' }}>{cred.password}</span>
